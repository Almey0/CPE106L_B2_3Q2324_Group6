'''
Modify the sentence-generator program of Case Study 5.3:· METIS book: 9781337671019, page 150. 
...
The function should open an input file with this name, define a temporary list, read words from the file, and 
add them to the list. The function should then convert the list to atuple and return this tuple. 
