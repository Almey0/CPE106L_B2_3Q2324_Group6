...
that compute the median and mode of a set of numbers, as defined in the below sample programs:
median.py
mode.py
...
numbers as an argument and return a single number. Each function should return 0 if the list is empty. 
